...
| 2026-07-07 | `npm run test -- src/lib/world/adventure-baseline.test.ts` after review remediation | passed, 1 file / 4 tests | focused automated test | Confirmed selected-baseline helper behavior before seeded reset cleanup was later simplified to delete all actor facts and restore only source-baseline facts. |
