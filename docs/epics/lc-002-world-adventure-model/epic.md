...
| R3-S1 and R3-S2 | `tests/e2e/lorecraft-playtest.spec.ts` updated on 2026-07-08 plus `npm run test` and `npm run typecheck` | Browser coverage exists for prompting for a player name, canceling creation, opening a named Adventure, and showing that name in the Player Card. | Added |
