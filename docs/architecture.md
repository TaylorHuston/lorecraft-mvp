...
- `src/lib/world/`: Stormbound Chapel baseline builders plus Convex-facing read-model, Game Master context, and turn-persistence helper modules kept outside generated Convex API routing.
