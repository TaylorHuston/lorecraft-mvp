...
This keeps playtesting focused on the initial seed, transcript behavior, prompt shape, and Game Master loop. Polished World management, Adventure pickers, source patching, branching, and long-lived save files are deferred until the core story loop is worth preserving.
