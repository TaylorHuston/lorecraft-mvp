...
- The default app opens an Adventure landing screen where the player can continue an existing Adventure or create a new one from the current WorldVersion.
